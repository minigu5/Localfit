...
3. Tailscale SSH PC 13대에서 v6 실측 수집
...
- `[코드 완료 / 배포 대기]` Firebase v6 telemetry rules
- `[준비 중]` Tailscale SSH PC 13대 실측 수집
- `[보류]` 새 예측 모델 공개 — direct-v6 데이터 부족
